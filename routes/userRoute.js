...
//products
user_route.get('/ProductDetails',auth.isLogin,product.loadProductDetails);

//cart -// checkout
user_route.get('/cartPage',auth.isLogin,cart.loadCart);
...
user_route.get('/products',auth.isLogin,product.loadProducts);
